...
**Using it** — [What this is, and what it is not](#what-this-is-and-what-it-is-not) ·
...
[Running](#running) ·
[Extracting from one note](#extracting-from-one-note) ·
[Routing, pipeline and workflows](#routing-pipeline-and-workflows) ·
[Writing a profile](#writing-a-profile)

**What it is worth** — [Verification](#verification) ·
[Traces](#traces) ·
[Eight tasks over four corpora](#eight-tasks-over-four-corpora) ·
[Quote, then tidy](#quote-then-tidy) ·
[How hard the notes are](#how-hard-the-notes-are) ·
[What a run costs](#what-a-run-costs) ·
[Measured](#measured)

**Reference** — [Nomenclature](#nomenclature) ·
[Layout](#layout) ·
[Status](#status) ·
